...
key_map <- c(
  "Methylation_matrix.csv"            = "Methylation_matrix",
  "Illumina_matrix.csv"               = "Illumina_matrix",
  "DNA_Methylation_Scores.csv"        = "dnam_score",
  "camda_matrix.csv"                  = "camda_score",
  "estimate_cell_counts.csv"          = "ECC",
  "coverage_matrix.csv"               = "coverage_matrix",
