...
## <sup>Total Read Depth</sup>

```{r}
#| echo: false
#| label: total-read-depth
#| error: true
#| fig-cap: "**Figure 13**: Total read depth across all measured loci. This represents the total sequencing yield for each sample."
...
ggplot(total_cov,
  ...
  labs(title    = paste("Total Read Depth Across", roi_label),
