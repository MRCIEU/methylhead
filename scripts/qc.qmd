...
for (path in files_path$V1) {
  ...
  if (grepl("_read_counts\\.tsv$", fname)) {
...
for (path in files_path$V1) {
  ...
  if (grepl("_panel_depth\\.tsv$", fname)) {
...
* This plot illustrates the distribution of coverage for each sample, with CpG sites represented along the y-axis and coverage values on the x-axis.
