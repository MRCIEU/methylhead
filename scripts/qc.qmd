...
#| code-fold: false
#| fig-cap: "**Figure 4**:  Comparison of Coverage per Sample Between Panel CpG sites and Total CpG sites."
...
* Depth: This plot shows, for each library, the plot shows the total read-base count across all CpG sites—that is, the sum of per-base depths extracted directly from the sorted BAM file with samtools.
