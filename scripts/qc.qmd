...
ggplot(
  ...
  annotate(
    ...
    label = glue(
      "Total CpG sites: {n_panel_cpg_sites}\n",
      "Panel CpG sites: {n_total_cpg_sites}\n",
      "Samples: {n_samples}"
    )
  ) +
...
* Coverage: This plot tracks how many unique CpG loci are successfully detected (e.g., those with at least one mapped read), complementing depth-based QC by ensuring a broad range of sites were captured.
...
#| error: true
#| fig-cap: "**Figure 16**: CpG Coverage Completeness per Sample"
