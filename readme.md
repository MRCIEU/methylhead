...
```bash
bash prepare_reference_genome.sh [path_to_folder] `[bed_file_path]`: https://github.com/MRCIEU/dnam-lung-cancer-pipeline/tree/main/data/blood_cell_types_extened.bed` defines the actual URL for the reference.
```
